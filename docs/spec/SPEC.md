...
- [Siege Engines / 공성병기 (부대 소속 공성 유닛)](features/siege-engines.md) — 투석기(공격 50·HP 60) 등 인구 비소모 재사용 유닛. 공성 작업장 생산·견인 이동(2·사람 4명+)·[투석](사거리 5·선택 모드)으로 성벽(내구도 180)을 랜덤 피해(30~70)로 깎아 평균 3~6발에 붕괴하거나 적 부대를 폭격(최대 5명·유닛별 명중). NPC 투석 AI는 후속
