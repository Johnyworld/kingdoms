...
| `sawmill` | 4 | 목재 10 / 철괴 2 | 목재 2 | 0 | — | (변환) | **[2차 생산](../features/processing.md)** — 나무1→목재1. 거점 인접 |
| `mill` | 3 | 목재 8 / 석재 4 | 목재 1 | 0 | — | (변환) | **[2차 생산](../features/processing.md)** — 밀1→밀가루1 |
| `bakery` | 4 | 목재 10 / 석재 6 | 목재 1 / 석재 1 | 0 | — | (변환) | **[2차 생산](../features/processing.md)** — 밀가루1→빵1 |
| `stable` | 5 | 목재 15 / 밀 8 | 목재 2 | 0 | — | (변환) | **[2차 생산](../features/processing.md)** — 밀2→고기1 + **가죽1**(부산물) |
| `ranch` | 4 | 목재 12 / 밀 5 | 목재 2 | 0 | — | (변환) | **[2차 생산](../features/processing.md)** — 밀2→고기1 + **천1**(부산물) |
| `smelter` | 5 | 목재 12 / 석재 10 | 목재 2 / 석재 2 | 0 | — | (변환) | **[2차 생산](../features/processing.md)** — 철→철괴/은→은괴/금→금괴(레시피 선택) |
