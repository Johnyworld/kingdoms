...
- 공격·점령은 부대 공격 행동을 끝낸다(`mark_attacked`). (중앙 메뉴의 [사격]/[취소], [휴식]·[경계]는 삭제됨. **[대기]는 부대 정보 패널로 이동** — 남은 이동력·공격을 포기하고 강제 E: [Party Info](party-info.md) · [Turn](turn.md#턴-종료-버튼-turn_hudgd).)
