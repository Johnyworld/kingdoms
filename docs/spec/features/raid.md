...
- 승자·패자 모두 지속 부대([Garrison / 주둔](garrison.md) 부대 포함 — 이제 수비대도 지속 부대다)라, 노획물은 **승자 부대 자신이 보유**한다. (임시 방어부대·영지 귀속 로직은 [수비대 통합](garrison.md)으로 폐지됨.)
...
거점을 지키는 [주둔 부대](garrison.md)는 이제 **지속 부대**다. **방어 승리**(공격자 전멸) 시 노획물을 (플레이어면 [약탈 패널](#승자가-플레이어-부대-관전-전투--_run_battle), NPC면 전량 자동) **그 부대 자신이 보유**한다 — 일반 부대 승리와 완전히 동일. 플레이어 주둔 부대의 노획물은 [캠프 메뉴](camp-menu.md)에서 판매·운반할 수 있다.

*(예전의 임시 수비대 부대·`home_territory` 영지 귀속·`Territory.receive_loot`/`loot_items`·영지 장비 판매는 [수비대 통합](garrison.md)으로 폐지됐다.)*
...
- 승자 판정(한쪽만 전멸)·플레이어 승자 패널(좌 노획 2섹션 / 우 내 인벤토리 읽기 전용)·NPC 자동 전량은 `game.gd` 배선이라 실제 실행으로 확인한다. 주둔 부대의 방어 승리 노획도 지속 부대와 같은 경로라 별도 배선이 없다.
