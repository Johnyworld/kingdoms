...
- 승자·패자 모두 지속 부대([Garrison / 주둔](garrison.md) 부대 포함)라, 노획물은 **승자 부대 자신이 보유**한다.
...
거점을 지키는 [주둔 부대](garrison.md)는 이제 **지속 부대**다. **방어 승리**(공격자 전멸) 시 노획 장비를 (플레이어면 [약탈 패널](#승자가-플레이어-부대-관전-전투--_run_battle), NPC면 전량 자동) **그 부대 자신이 보유**한다 — 일반 부대 승리와 완전히 동일.
